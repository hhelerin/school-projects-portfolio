        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousExpiation = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomersUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomersUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinearMeter = table.Column<double>(type: "double precision", nullable: true),
                    Details = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    Status = table.Column<string>(type: "text", nullable: false),
                    ShipmentID = table.Column<Guid>(type: "uuid", nullable: true),
                    PalletNumber = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "OperationMappings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProcessingStepId = table.Column<Guid>(type: "uuid", nullable: false),
                    OrderId = table.Column<Guid>(type: "uuid", nullable: false),
                    PrerequisitesObtained = table.Column<bool>(type: "boolean", nullable: false),
                    CompletedAt = table.Column<DateOnly>(type: "date", nullable: true),
                    Details = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperationMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OperationMappings_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OperationMappings_ProcessingSteps_ProcessingStepId",
                        column: x => x.ProcessingStepId,
                        principalTable: "ProcessingSteps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomersUsers_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperationMappings_OrderId",
                table: "OperationMappings",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OperationMappings_ProcessingStepId",
                table: "OperationMappings",
                column: "ProcessingStepId");
